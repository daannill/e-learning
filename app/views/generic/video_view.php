    ...
    <main class="dashboard-content">
        <div class="dashboard-container dashboard-container--form">
            ...
            <div class="dashboard-topbar">
                ...
                <a href="<?= BASEURL . '/edit/video/' . ($material['material_id'] ?? '') ?>" class="btn btn-sm btn-primary">
                    Edit Material
                </a>
            </div>
            ...
            <div class="card">
                ...
                <div class="form-step" id="formStep1">
                    ...
                    <div class="form-section">
                        <h2 class="form-section-title">Material Video</h2>

                        <div class="material-meta">
                            <?php if (($material['video_source'] ?? 'youtube') === 'video') : ?>
                        ...
                        <div class="video-player-wrapper">
                            ...
                            <?php if (($material['video_source'] ?? 'youtube') === 'video') : ?>
                                ...
                                <video
                                    controls
                                    playsinline
                                    src="<?= htmlspecialchars(BASEURL . '/uploads/material-videos/' . ($material['video_path'] ?? '')) ?>"
                                ></video>

                            <?php else : ?>

                                <?php $embedUrl = getYoutubeEmbedUrl($material['video_url'] ?? ''); ?>
